...
async def process_polyline(polyline: list):
  # Convert polyline to GeoDataFrame through LineString
  decoded_path = [(lng, lat) for lat, lng in polyline]
  ...
  intersected_counties = gpd.sjoin(counties_gdf, polyline_gdf, how="inner", op="intersects")
